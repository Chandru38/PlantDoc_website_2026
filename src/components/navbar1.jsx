...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed top-0 left-0 h-full bg-navbar z-50
...
const NavItem3= ({ label, collapsed }) => {
  return (
    <a href="#contact-us" className="flex items-center gap-3 p-1 rounded hover:bg-surface-2 transition">
      <div className=" rounded">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-question-circle" viewBox="0 0 16 16">
