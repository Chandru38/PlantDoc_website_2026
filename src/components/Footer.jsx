...
const Footer = ({theme}) => {
  return (
    <div className='text-text bg-(--color-hero) pt-10 sm:pt-10  px-4 sm:px-10 sm:ml-25 lg:px-24 xl:px-40'>
        ...
        <div className='pb-5 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <a href="https://chat.whatsapp.com/KB7pQnl1jugIKwFcTr2cLh"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
